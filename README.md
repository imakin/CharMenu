...
This CharMenu uses lcd_lib.h from Scienceprog.com (GPL license). We all know that embedded system firmware were built statically linked to any library it uses, thus the same license is used for this CharMenu.
